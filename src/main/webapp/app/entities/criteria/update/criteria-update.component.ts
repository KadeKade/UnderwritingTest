...
export class CriteriaUpdateComponent implements OnInit {
  ...
  criteriaPropertiesSharedCollection: ICriteriaProperty[] = [];
  ...
  compareCriteriaProperty = (o1: ICriteriaProperty | null, o2: ICriteriaProperty | null): boolean =>
    this.criteriaPropertyService.compareCriteriaProperty(o1, o2);
  ...
  protected updateForm(criteria: ICriteria): void {
    ...
    this.criteriaPropertiesSharedCollection = this.criteriaPropertyService.addCriteriaPropertyToCollectionIfMissing<ICriteriaProperty>(
      this.criteriaPropertiesSharedCollection,
      criteria.property
    );
  ...
  protected loadRelationshipsOptions(): void {
    this.criteriaPropertyService
      .query()
      .pipe(map((res: HttpResponse<ICriteriaProperty[]>) => res.body ?? []))
      .pipe(
        map((criteriaProperties: ICriteriaProperty[]) =>
          this.criteriaPropertyService.addCriteriaPropertyToCollectionIfMissing<ICriteriaProperty>(
            criteriaProperties,
            this.criteria?.property
          )
        )
      )
      .subscribe((criteriaProperties: ICriteriaProperty[]) => (this.criteriaPropertiesSharedCollection = criteriaProperties));
