...
describe('Criteria Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call CriteriaSet query and add missing value', () => {
      ...
      const criterias: ICriteriaSet = { id: 13163 };
      criteria.criterias = criterias;
      ...
      const additionalCriteriaSets = [criterias];
    ...
    it('Should update editForm', () => {
      const criteria: ICriteria = { id: 456 };
      const criterias: ICriteriaSet = { id: 90725 };
      criteria.criterias = criterias;

      activatedRoute.data = of({ criteria });
      comp.ngOnInit();

      expect(comp.criteriaSetsSharedCollection).toContain(criterias);
