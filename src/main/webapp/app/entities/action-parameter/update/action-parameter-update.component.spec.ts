...
describe('ActionParameter Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call AutomatedAction query and add missing value', () => {
      ...
      const positiveAutomatedActions: IAutomatedAction = { id: 41046 };
      actionParameter.positiveAutomatedActions = positiveAutomatedActions;
      const negativeAutomatedActions: IAutomatedAction = { id: 95822 };
      actionParameter.negativeAutomatedActions = negativeAutomatedActions;

      const automatedActionCollection: IAutomatedAction[] = [{ id: 65845 }];
      jest.spyOn(automatedActionService, 'query').mockReturnValue(of(new HttpResponse({ body: automatedActionCollection })));
      const additionalAutomatedActions = [positiveAutomatedActions, negativeAutomatedActions];
    ...
    it('Should update editForm', () => {
      const actionParameter: IActionParameter = { id: 456 };
      const positiveAutomatedActions: IAutomatedAction = { id: 3999 };
      actionParameter.positiveAutomatedActions = positiveAutomatedActions;
      const negativeAutomatedActions: IAutomatedAction = { id: 88580 };
      actionParameter.negativeAutomatedActions = negativeAutomatedActions;

      activatedRoute.data = of({ actionParameter });
      comp.ngOnInit();

      expect(comp.automatedActionsSharedCollection).toContain(positiveAutomatedActions);
      expect(comp.automatedActionsSharedCollection).toContain(negativeAutomatedActions);
