...
public class CriteriaSet implements Serializable {
    ...
    @Column(name = "broker_category")
    private String brokerCategory;

    @OneToMany(mappedBy = "criteriaSet")
    @JsonIgnoreProperties(value = { "criteriaParameters", "criteriaSet" }, allowSetters = true)
    ...
    public CriteriaSet brokerCategory(String brokerCategory) {
        this.setBrokerCategory(brokerCategory);
        return this;
    }

    public void setBrokerCategory(String brokerCategory) {
    ...
    public String toString() {
        return "CriteriaSet{" +
            ...
            ", lobId=" + getLobId() +
            ", brokerCategory='" + getBrokerCategory() + "'" +
            "}";
    }
}
