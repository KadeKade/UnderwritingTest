...
public class Criteria implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "criteria", "automatedAction" }, allowSetters = true)
    private CriteriaSet criterias;
    ...
    public CriteriaSet getCriterias() {
        return this.criterias;
    }

    public void setCriterias(CriteriaSet criteriaSet) {
        this.criterias = criteriaSet;
    }

    public Criteria criterias(CriteriaSet criteriaSet) {
        this.setCriterias(criteriaSet);
        return this;
    }
