...
public class BrokerCategoryResource {
    ...
    public BrokerCategoryResource(BrokerCategoryRepository brokerCategoryRepository) {
    ...
    public ResponseEntity<BrokerCategory> updateBrokerCategory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, brokerCategory.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BrokerCategory> partialUpdateBrokerCategory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, brokerCategory.getId().toString())
        );
    }
