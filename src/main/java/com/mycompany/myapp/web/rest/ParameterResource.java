...
public class ParameterResource {
    ...
    public ResponseEntity<Parameter> partialUpdateParameter(
        ...
        Optional<Parameter> result = parameterRepository
            ...
            .map(existingParameter -> {
                if (parameter.getParameterName() != null) {
                    existingParameter.setParameterName(parameter.getParameterName());
                }
                if (parameter.getDisplayNameDe() != null) {
                    existingParameter.setDisplayNameDe(parameter.getDisplayNameDe());
                }
                if (parameter.getDisplayNameEn() != null) {
                    existingParameter.setDisplayNameEn(parameter.getDisplayNameEn());
                }
                if (parameter.getDisplayNameFr() != null) {
                    existingParameter.setDisplayNameFr(parameter.getDisplayNameFr());
                }
                if (parameter.getDisplayNameIt() != null) {
                    existingParameter.setDisplayNameIt(parameter.getDisplayNameIt());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, parameter.getId().toString())
        );
    }
