...
public class CriteriaParameterResource {
    ...
    public CriteriaParameterResource(CriteriaParameterRepository criteriaParameterRepository) {
    ...
    public ResponseEntity<CriteriaParameter> updateCriteriaParameter(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, criteriaParameter.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CriteriaParameter> partialUpdateCriteriaParameter(
        ...
        Optional<CriteriaParameter> result = criteriaParameterRepository
            ...
            .map(existingCriteriaParameter -> {
                if (criteriaParameter.getParameterKey() != null) {
                    existingCriteriaParameter.setParameterKey(criteriaParameter.getParameterKey());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, criteriaParameter.getId().toString())
        );
    }
