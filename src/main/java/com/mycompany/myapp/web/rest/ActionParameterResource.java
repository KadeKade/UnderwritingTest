...
public class ActionParameterResource {
    ...
    public ActionParameterResource(ActionParameterRepository actionParameterRepository) {
    ...
    public ResponseEntity<ActionParameter> updateActionParameter(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, actionParameter.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ActionParameter> partialUpdateActionParameter(
        ...
        Optional<ActionParameter> result = actionParameterRepository
            ...
            .map(existingActionParameter -> {
                ...
                if (actionParameter.getDisplayNameDe() != null) {
                    existingActionParameter.setDisplayNameDe(actionParameter.getDisplayNameDe());
                }
                if (actionParameter.getDisplayNameEn() != null) {
                    existingActionParameter.setDisplayNameEn(actionParameter.getDisplayNameEn());
                }
                if (actionParameter.getDisplayNameFr() != null) {
                    existingActionParameter.setDisplayNameFr(actionParameter.getDisplayNameFr());
                }
                if (actionParameter.getDisplayNameIt() != null) {
                    existingActionParameter.setDisplayNameIt(actionParameter.getDisplayNameIt());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, actionParameter.getId().toString())
        );
    }
