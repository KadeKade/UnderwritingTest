...
public class AutomatedActionResource {
    ...
    public AutomatedActionResource(AutomatedActionRepository automatedActionRepository) {
    ...
    public ResponseEntity<AutomatedAction> updateAutomatedAction(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, automatedAction.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AutomatedAction> partialUpdateAutomatedAction(
        ...
        Optional<AutomatedAction> result = automatedActionRepository
            ...
            .map(existingAutomatedAction -> {
                ...
                if (automatedAction.getNegativeActionPropertyValue() != null) {
                    existingAutomatedAction.setNegativeActionPropertyValue(automatedAction.getNegativeActionPropertyValue());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, automatedAction.getId().toString())
        );
    }
