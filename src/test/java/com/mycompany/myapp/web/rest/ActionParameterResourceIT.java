...
class ActionParameterResourceIT {
    ...
    void createActionParameter() throws Exception {
        ...
        assertThat(testActionParameter.getDisplayNameDe()).isEqualTo(DEFAULT_DISPLAY_NAME_DE);
        assertThat(testActionParameter.getDisplayNameEn()).isEqualTo(DEFAULT_DISPLAY_NAME_EN);
        assertThat(testActionParameter.getDisplayNameFr()).isEqualTo(DEFAULT_DISPLAY_NAME_FR);
        assertThat(testActionParameter.getDisplayNameIt()).isEqualTo(DEFAULT_DISPLAY_NAME_IT);
    }
    ...
    void putExistingActionParameter() throws Exception {
        ...
        assertThat(testActionParameter.getDisplayNameDe()).isEqualTo(UPDATED_DISPLAY_NAME_DE);
        assertThat(testActionParameter.getDisplayNameEn()).isEqualTo(UPDATED_DISPLAY_NAME_EN);
        assertThat(testActionParameter.getDisplayNameFr()).isEqualTo(UPDATED_DISPLAY_NAME_FR);
        assertThat(testActionParameter.getDisplayNameIt()).isEqualTo(UPDATED_DISPLAY_NAME_IT);
    }
