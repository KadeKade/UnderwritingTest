...
class CriteriaResourceIT {
    ...
    private static final CriteriaType DEFAULT_CRITERIA_TYPE = CriteriaType.POSITIVE;
    private static final CriteriaType UPDATED_CRITERIA_TYPE = CriteriaType.NEGATIVE;
    ...
    public static Criteria createEntity(EntityManager em) {
        Criteria criteria = new Criteria()
            .criteriaType(DEFAULT_CRITERIA_TYPE)
    ...
    public static Criteria createUpdatedEntity(EntityManager em) {
        Criteria criteria = new Criteria()
            .criteriaType(UPDATED_CRITERIA_TYPE)
    ...
    void createCriteria() throws Exception {
        ...
        assertThat(testCriteria.getCriteriaType()).isEqualTo(DEFAULT_CRITERIA_TYPE);
    ...
    void getAllCriteria() throws Exception {
        ...
        restCriteriaMockMvc
            ...
            .andExpect(jsonPath("$.[*].criteriaType").value(hasItem(DEFAULT_CRITERIA_TYPE.toString())))
    ...
    void getCriteria() throws Exception {
        ...
        restCriteriaMockMvc
            ...
            .andExpect(jsonPath("$.criteriaType").value(DEFAULT_CRITERIA_TYPE.toString()))
    ...
    void putExistingCriteria() throws Exception {
        ...
        Criteria testCriteria = criteriaList.get(criteriaList.size() - 1);
        assertThat(testCriteria.getCriteriaType()).isEqualTo(UPDATED_CRITERIA_TYPE);
    ...
    void partialUpdateCriteriaWithPatch() throws Exception {
        ...
        partialUpdatedCriteria.criteriaType(UPDATED_CRITERIA_TYPE).criteriaPropertyValue(UPDATED_CRITERIA_PROPERTY_VALUE);
