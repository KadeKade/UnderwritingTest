...
class AutomatedActionResourceIT {
    ...
    private static final String DEFAULT_NEGATIVE_ACTION_PROPERTY_VALUE = "AAAAAAAAAA";
    private static final String UPDATED_NEGATIVE_ACTION_PROPERTY_VALUE = "BBBBBBBBBB";
    ...
    public static AutomatedAction createEntity(EntityManager em) {
        AutomatedAction automatedAction = new AutomatedAction()
            ...
            .negativeActionPropertyValue(DEFAULT_NEGATIVE_ACTION_PROPERTY_VALUE)
    ...
    public static AutomatedAction createUpdatedEntity(EntityManager em) {
        AutomatedAction automatedAction = new AutomatedAction()
            ...
            .negativeActionPropertyValue(UPDATED_NEGATIVE_ACTION_PROPERTY_VALUE)
    ...
    void createAutomatedAction() throws Exception {
        ...
        assertThat(testAutomatedAction.getNegativeActionPropertyValue()).isEqualTo(DEFAULT_NEGATIVE_ACTION_PROPERTY_VALUE);
    ...
    void getAllAutomatedActions() throws Exception {
        ...
        restAutomatedActionMockMvc
            ...
            .andExpect(jsonPath("$.[*].negativeActionPropertyValue").value(hasItem(DEFAULT_NEGATIVE_ACTION_PROPERTY_VALUE)))
    ...
    void getAutomatedAction() throws Exception {
        ...
        restAutomatedActionMockMvc
            ...
            .andExpect(jsonPath("$.negativeActionPropertyValue").value(DEFAULT_NEGATIVE_ACTION_PROPERTY_VALUE))
    ...
    void putExistingAutomatedAction() throws Exception {
        ...
        assertThat(testAutomatedAction.getNegativeActionPropertyValue()).isEqualTo(UPDATED_NEGATIVE_ACTION_PROPERTY_VALUE);
    ...
    void partialUpdateAutomatedActionWithPatch() throws Exception {
        ...
        partialUpdatedAutomatedAction.negativeActionDefinition(UPDATED_NEGATIVE_ACTION_DEFINITION).displayNameIt(UPDATED_DISPLAY_NAME_IT);
