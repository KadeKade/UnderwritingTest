...
class CriteriaSetResourceIT {
    ...
    public static CriteriaSet createEntity(EntityManager em) {
        CriteriaSet criteriaSet = new CriteriaSet().name(DEFAULT_NAME).insurerId(DEFAULT_INSURER_ID).lobId(DEFAULT_LOB_ID);
        return criteriaSet;
    }
    ...
    public static CriteriaSet createUpdatedEntity(EntityManager em) {
        CriteriaSet criteriaSet = new CriteriaSet().name(UPDATED_NAME).insurerId(UPDATED_INSURER_ID).lobId(UPDATED_LOB_ID);
        return criteriaSet;
    }
    ...
    void putExistingCriteriaSet() throws Exception {
        ...
        updatedCriteriaSet.name(UPDATED_NAME).insurerId(UPDATED_INSURER_ID).lobId(UPDATED_LOB_ID);
    ...
    void partialUpdateCriteriaSetWithPatch() throws Exception {
        ...
        partialUpdatedCriteriaSet.insurerId(UPDATED_INSURER_ID);
    ...
    void fullUpdateCriteriaSetWithPatch() throws Exception {
        ...
        partialUpdatedCriteriaSet.name(UPDATED_NAME).insurerId(UPDATED_INSURER_ID).lobId(UPDATED_LOB_ID);
